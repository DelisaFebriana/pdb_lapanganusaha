                ...
                <tbody>
                    <?php foreach ($cat1 as $item): ?>
                      ...
                      <tr>
                        ...
                        <!-- Tombol Edit -->
                        <td>
                        <a href="/adminpdb/<?= $item['id'] ?>/edit" class="btn btn-sm btn-primary" style="background-color: #003366; color: white; border-radius: 0; border-top-left-radius: 5px; border-bottom-left-radius: 5px;"><i class="fas fa-edit"></i>
                        </td>

                        <!-- Tombol Delete -->
                        <td>
                        <form action="/adminpdb/delete/<?= $item['id'] ?>" method="POST"style="border-radius: 0; border-top-right-radius: 5px; border-bottom-right-radius: 5px;">
