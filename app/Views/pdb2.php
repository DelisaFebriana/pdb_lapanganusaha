...
<body id="body">
  ...
  <div class="container mt-5">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?= site_url('pdb2/downloadExcel') ?>" class="btn btn-primary"><i class="fa fa-download me-3"></i>Download Excel</a>
      </div>
  ...
  <script>
    ...
    function downloadExcel() {
      var year = document.getElementById('select-year').value;
      window.location.href = "/pdb2/downloadExcel?tahun=" + year;
      }
  </script>
